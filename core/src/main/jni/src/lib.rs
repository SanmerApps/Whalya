...
define_java_class!(JPkiTypes, "dev/sanmer/core/PkiTypes");
define_java_class!(
    JPrivatePkcs8KeyDer,
    "dev/sanmer/core/PkiTypes$PrivatePkcs8KeyDer"
);
...
#[no_mangle]
pub extern "C" fn Java_dev_sanmer_core_PkiTypes_loadToPkcs8<'ctx>(
    ctx: &'ctx Context,
...
converter!(
    Java_dev_sanmer_core_PkiTypes_pkcs8ToSec1,
    PrivatePkcs8KeyDer,
    PrivateSec1KeyDer
);

converter!(
    Java_dev_sanmer_core_PkiTypes_sec1ToPkcs8,
    PrivateSec1KeyDer,
    PrivatePkcs8KeyDer
);

converter!(
    Java_dev_sanmer_core_PkiTypes_pkcs8ToPkcs1,
    PrivatePkcs8KeyDer,
    PrivatePkcs1KeyDer
);

converter!(
    Java_dev_sanmer_core_PkiTypes_pkcs1ToPkcs8,
    PrivatePkcs1KeyDer,
    PrivatePkcs8KeyDer
);

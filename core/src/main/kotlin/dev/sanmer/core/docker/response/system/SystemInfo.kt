...
data class SystemInfo(
    ...
    @SerialName("SystemTime") val systemTime: Instant,
    ...
    @Serializable
    data class Plugins(
        @SerialName("Volume") val volume: List<String>,
        @SerialName("Network") val network: List<String>,
        @SerialName("Authorization") val authorization: List<String> = emptyList(),
        @SerialName("Log") val log: List<String>
    )
}

...
data class Network(
    ...
    @SerialName("IPAM") val ipAM: NetworkConfig.IPAM,
    ...
    @SerialName("ConfigFrom") val configFrom: NetworkConfig.ConfigReference,
    ...
    @SerialName("Peers") val peers: List<PeerInfo> = emptyList()
) {
    @Serializable
